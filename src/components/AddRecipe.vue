<template>
  <form class="form" @submit.prevent="submit">
    ...
    <div v-if="visible">
      <div class="input">
        <input type="text" placeholder="Назва рецепта" v-model="form.title" />
      </div>
      <div class="input">
        <input
          type="text"
    ...
    <div class="buttons">
      <button class="btn" type="submit" :disabled="!valid">Створити</button>
      <button class="btn secondary" type="button" @click="toggle">
        {{ visible ? "Прибрати" : "Показати" }} форму
      </button>
    </div>
  </form>
</template>
